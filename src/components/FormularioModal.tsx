...
export default function FormularioModal() {
  ...
  return (
    <>
      <div className="fixed right-5 bottom-5 flex items-center justify-center transform transition-transform duration-300 hover:scale-110">
        <button type="button" onClick={() => dispatch({ type: "abrir-modal" })}>
      ...
      <Transition appear show={state.modal} as={Fragment}>
        <Dialog
          ...
          onClose={() => dispatch({ type: "cerrar-modal" })}
        >
          <TransitionChild
            as={Fragment}
